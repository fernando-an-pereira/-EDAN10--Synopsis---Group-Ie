...
\section{Method}
To solve the problems of the company, we will start studying deeply how the developers work. We'll analyse how the concurrent development is done.
...
The company will need a Configuration Manager. It can be a new employee, or a developer will be promoted to this function. We'll provide training to him.

Another important thing is to do a CM plan to the company. This plan will be used as basis to the company to every CM plan it will do to specific projects.
